...
{
public:
	RenderMesh3D(uint32_t i, const void* meshData, const uint32_t meshDataLength, const void* textureData) : _id(i), _mesh(meshData, meshDataLength), _texture(textureData) {}
